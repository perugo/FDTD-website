...
$filename="/home/your_username/html2_project/inputfol/bitmap_info.txt";
...
if(isset($bitmap) && isset($xnum) && isset($ynum) && isset($resolution) && isset($frequency_coefficient) && isset($frequency_power) && isset($source_x) && isset($source_y)){
